...
func insertClusterTrack(t *testing.T, db *gorm.DB, index int, embedding []float32) string {
	...
	statements := []struct {
		...
		{query: `INSERT INTO speaker_tracks(id, meeting_id, asr_session_id, asr_speaker_label, state, evidence_duration_ms, model_id, model_version, model_sha256, dimension, embedding, profile_id, revision, created_at, updated_at) VALUES (?, '11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222222', ?, 'ambiguous', 1000, 'model', 'v1', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 2, ?, 'test-profile', 1, 0, 0)`, args: []any{trackID, "speaker-" + string(rune('0'+index)), blob}},
